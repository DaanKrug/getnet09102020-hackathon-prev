...
export class FixedcostService extends BaseCrudService {
	...
	getAll(page,rows,conditions): Promise<Fixedcost[]> {
		return new Promise<Fixedcost[]>(r => r(super.getAll(page,rows,this.getEmptyObject(conditions))));
	}
	...
	mergeAnotherInObject(object,anotherObject){
		...
		object.a3_qtde = super.getChangedValue(anotherObject.a3_qtde,object.a3_qtde);
