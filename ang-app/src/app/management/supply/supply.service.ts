...
export class SupplyService extends BaseCrudService {
	...
	getAll(page,rows,conditions): Promise<Supply[]> {
		return new Promise<Supply[]>(r => r(super.getAll(page,rows,this.getEmptyObject(conditions))));
	}
	...
	mergeAnotherInObject(object,anotherObject){
		...
		object.a3_un = super.getChangedValue(anotherObject.a3_un,object.a3_un); 
